...
#ifndef ESPM_UPOWER_COMMON
#define ESPM_UPOWER_COMMON
...
#define POLKIT_AUTH_SUSPEND_ESPM	"com.expidus.power.expidus1-pm-helper"
#define POLKIT_AUTH_HIBERNATE_ESPM	"com.expidus.power.expidus1-pm-helper"
...
const gchar *espm_power_translate_device_type         (guint         type);
const gchar *espm_power_translate_technology          (guint         value);
gchar       *espm_battery_get_time_string             (guint         seconds);
