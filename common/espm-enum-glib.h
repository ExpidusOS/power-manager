...
#ifndef __ESPM_ENUM_GLIB_H
#define __ESPM_ENUM_GLIB_H
...
typedef enum
{
  ...
  ESPM_BATTERY_CHARGE_CRITICAL,
  ESPM_BATTERY_CHARGE_LOW,
  ESPM_BATTERY_CHARGE_OK
} EspmBatteryCharge;
