...
void
espm_debug (const char *func, const char *file, int line, const char *format, ...)
{
  va_list args;
...
void
espm_warn (const char *func, const char *file, int line, const char *format, ...)
{
  va_list args;
...
void
espm_debug_enum (const gchar *func, const gchar *file, gint line,
...
void
espm_debug_init (gboolean debug)
{
    enable_debug = debug;
}
