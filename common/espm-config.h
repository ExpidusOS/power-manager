...
#ifndef __ESPM_CONFIG_H
#define __ESPM_CONFIG_H
...
#define ESPM_CHANNEL                         "expidus1-power-manager"
#define ESPM_PROPERTIES_PREFIX               "/expidus1-power-manager/"
