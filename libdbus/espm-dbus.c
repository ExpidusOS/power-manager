...
gboolean
espm_dbus_name_has_owner (GDBusConnection *connection, const gchar *name)
{
  GError *error = NULL;
...
gboolean espm_dbus_register_name(GDBusConnection *connection, const gchar *name)
{
  GError *error = NULL;
  guint32 ret = 0;
  GVariant *var;
...
gboolean espm_dbus_release_name(GDBusConnection *connection, const gchar *name)
{
  GError *error = NULL;
  GVariant *var;
